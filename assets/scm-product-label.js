...
if ((typeof SECOMAPP) == 'undefined') {
    ...
    SECOMAPP.pl.labels = [
            ...
            'priority': 0,
            'hide': 0,
            'image': 'https://d3azqz9xba9gwd.cloudfront.net/storage/labels/yellow-the-label/63e7e353edd7c.png',
                        'position': 'top_right',
            'styles': '',
            'text_styles': '',
            'label_width': 17,
    ...
    SECOMAPP.pl.labelCollections = function (force) {
        ...
        searchCallback = function (json) {
            ...
            if (json.results_count > 50 && ((typeof SECOMAPP.pl.search) == 'undefined' || !SECOMAPP.pl.search.hasOwnProperty(json.query))) {
                ...
                for (var page = 2; page <= Math.floor((json.results_count + 49) / 50); page++) {
                    ...
                    jQuery.getScript('/search.js?page=' + page + '&q=' + query + '&view=scm.products.handle.js&_sc=1&design_theme_id=132210524311&app=pl');
                }
            }
        };
        ...
        for (var handle in productImages) {
            ...
            h++;
            if (h >= 50) {
                jQuery.getScript('/search.js?q=' + fullQuery + '&view=scm.products.handle.js&_sc=1&design_theme_id=132210524311&app=pl');
                fullQuery = "";
                h = 0;
            }
        }
